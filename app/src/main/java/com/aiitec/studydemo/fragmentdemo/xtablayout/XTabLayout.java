package com.aiitec.studydemo.fragmentdemo.xtablayout;
...
public class XTabLayout extends HorizontalScrollView {
    ...
    //指示器形状是否是原型,默认方形
    private boolean xTabIndicatorCircle = false;
    //圆形指示器的半径大小
    private int xTabIndicatorCircleRadius = 10;
   ...
   /*     TypedArray a = context.obtainStyledAttributes(attrs, android.support.design.R.styleable.TabLayout,
        ...
        xTabIndicatorCircle = a.getBoolean(R.styleable.XTabLayout_xTabIndicatorCircle, false);
        xTabIndicatorCircleRadius = a.getInteger(R.styleable.XTabLayout_xTabIndicatorCircleRadius, 10);
        ...
        public void draw(Canvas canvas) {
            ...
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
               ...
               /* int maxWidth = mIndicatorRight - mIndicatorLeft;
                ...
                if (xTabIndicatorCircle) {
                    //指示器为圆形
                    mSelectedIndicatorPaint.setColor(getResources().getColor(R.color.colorPrimary));
                    mSelectedIndicatorPaint.setAntiAlias(true);
                    canvas.drawCircle(mIndicatorLeft + xTabIndicatorCircleRadius,
                            getHeight() - xTabIndicatorCircleRadius, xTabIndicatorCircleRadius
